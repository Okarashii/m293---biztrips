	...
	return (
		<main className="flex w-screen h-screen">
			<aside className="flex flex-col gap-2 px-5 py-10 w-64 bg-slate-900 h-fit rounded-br-2xl">
				...
				<a className="bg-slate-600 px-4 py-2 rounded-lg w-fit" href='/addairport'>Flughafen hinzufügen</a>
				<a className="bg-slate-600 px-4 py-2 rounded-lg w-fit" href='/addflight'>Flug Hinzufügen</a>
				<a className="bg-slate-600 px-4 py-2 rounded-lg w-fit" href='/addhotel'>Hotel hinzufügen</a>
